...
CREATE TABLE `assets_sites` (
  ...
  KEY `fk_hzzehpcrpzslvnesxhbnhfyrrcrqzqryetwi` (`siteId`),
  CONSTRAINT `fk_hzzehpcrpzslvnesxhbnhfyrrcrqzqryetwi` FOREIGN KEY (`siteId`) REFERENCES `sites` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_rieibyvfjwirtztzbhfdqemhsdtaoepfnspo` FOREIGN KEY (`assetId`) REFERENCES `assets` (`id`) ON DELETE CASCADE
...
CREATE TABLE `authenticator` (
  ...
  `dateUpdated` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_atnbvmwjwunlwniwqoehlqaiigkvfifukqms` (`userId`),
  CONSTRAINT `fk_atnbvmwjwunlwniwqoehlqaiigkvfifukqms` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `elements_bulkops` (
  ...
  KEY `idx_gfumdijcqmlphrsuoiyibfaspzoioiwvqbts` (`timestamp`),
  CONSTRAINT `fk_hsazsptnedjdpicitlsqghhtczbpmotdsfnl` FOREIGN KEY (`elementId`) REFERENCES `elements` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `elements_owners` (
  ...
  KEY `fk_ycgmunhwunjkqkocizyqbkimsqtuiwiudtcr` (`ownerId`),
  CONSTRAINT `fk_ycgmunhwunjkqkocizyqbkimsqtuiwiudtcr` FOREIGN KEY (`ownerId`) REFERENCES `elements` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_zinqolhleeckdbokhctesstamrttkjwhcfrr` FOREIGN KEY (`elementId`) REFERENCES `elements` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `elements_sites` (
  ...
  KEY `idx_bzanzsqfgqvtnoarvzyrjjkiyrmqfwwewyeb` (`title`,`siteId`),
...
CREATE TABLE `entries` (
  ...
  KEY `idx_ozkfxltxiiunyuhmpcjmvytsnihhepsyehit` (`primaryOwnerId`),
  KEY `idx_itnwyduldzehgtaylzruwcqdpzcyoxzlckmh` (`fieldId`),
  CONSTRAINT `fk_erlyatcfzkynohnhcfoqlqdnmbdkerbkjlco` FOREIGN KEY (`primaryOwnerId`) REFERENCES `elements` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_kczhwfwsdnareifuosmjqggxvnrxozzzygbo` FOREIGN KEY (`id`) REFERENCES `elements` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_ooasywdzghmucldirzkzdkyfybhcnvcmrcdf` FOREIGN KEY (`fieldId`) REFERENCES `fields` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `entries_authors` (
  ...
  KEY `idx_jopzqmmcfpqqhmybtauhwapoyfwwfswgblrs` (`authorId`),
  KEY `idx_ttxnytxexsuixobediraarelywrvnsbkljsy` (`entryId`,`sortOrder`),
  CONSTRAINT `fk_dnestwptfoktkdrqjwltaeacrmppbcfacfag` FOREIGN KEY (`entryId`) REFERENCES `entries` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_gmwkdqqhaqyrdujhgmxlxnavkqrsnojefxwx` FOREIGN KEY (`authorId`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=355 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `recoverycodes` (
  ...
  `dateUpdated` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_ptzchafjaivgktexsldhrvmbfcrmlbvogsiu` (`userId`),
  CONSTRAINT `fk_ptzchafjaivgktexsldhrvmbfcrmlbvogsiu` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sections_entrytypes` (
  ...
  KEY `fk_izuviliyaolhuvorvemcqbpxcmochrnaooto` (`typeId`),
  CONSTRAINT `fk_ctiidqwpvhotgmiqopraponwltlsdrukgixo` FOREIGN KEY (`sectionId`) REFERENCES `sections` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_izuviliyaolhuvorvemcqbpxcmochrnaooto` FOREIGN KEY (`typeId`) REFERENCES `entrytypes` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `webauthn` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `fk_vmbqvkyvybodwqnyxwnbsberfjjpczirtkno` (`userId`),
  CONSTRAINT `fk_vmbqvkyvybodwqnyxwnbsberfjjpczirtkno` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-04-02 15:44:42
-- MariaDB dump 10.19  Distrib 10.6.14-MariaDB, for Linux (aarch64)
--
-- Host: mysql    Database: project
-- ------------------------------------------------------
...
set autocommit=0;
INSERT INTO `entrytypes` VALUES (1,1,'Countries - Default','countries_default',NULL,NULL,1,'site',NULL,NULL,1,'site',NULL,1,'2022-11-09 01:58:36','2024-04-02 15:39:53',NULL,'65a39f0b-19b3-4457-b8da-8bd66251a3b9'),(2,2,'Trips - Default','trips_default',NULL,NULL,1,'site',NULL,NULL,1,'site',NULL,1,'2022-11-09 01:58:47','2024-04-02 15:39:53',NULL,'87d4c11a-4922-4878-a4fc-b45e075a4066'),(3,4,'Recipes - Default','recipes_default',NULL,NULL,1,'site',NULL,NULL,1,'site',NULL,1,'2023-11-08 19:08:29','2024-04-02 15:39:53',NULL,'8343f4ab-c5bd-42a0-a37e-3c58121f759a'),(4,5,'Dietary Preferences - Default','dietaryPreferences_default',NULL,NULL,1,'site',NULL,NULL,1,'site',NULL,1,'2023-12-21 16:38:42','2024-04-02 15:39:53',NULL,'7d0487ea-cc61-4615-bbec-1d35fb6e0129'),(5,7,'Default','default',NULL,NULL,1,'site',NULL,NULL,1,'site',NULL,1,'2023-12-21 16:41:50','2023-12-21 16:41:50',NULL,'0ad8c9e9-84c2-4582-91e3-f726d2a16faf'),(6,8,'Step','step',NULL,NULL,0,'site',NULL,NULL,1,'site',NULL,1,'2024-04-02 15:39:53','2024-04-02 15:39:53',NULL,'2ff70388-58ff-42cc-b63c-8b6a921ff80a'),(7,6,'Ingredient','ingredient',NULL,NULL,0,'site',NULL,NULL,1,'site',NULL,1,'2024-04-02 15:39:53','2024-04-02 15:39:53',NULL,'350d3b36-f9ac-4a5c-9324-598b3fc4d31f');
...
set autocommit=0;
INSERT INTO `info` VALUES (1,'5.0.0','5.0.0.20',0,'nycpcjerjzea','3@zkfavrqvkp','2022-11-09 01:55:10','2024-04-02 15:43:16','b0a90193-b57d-4e13-87e0-b79179b6c2ed');
...
set autocommit=0;
INSERT INTO `plugins` VALUES (1,'dashboard-begone','3.0.0','1.0.0','2022-11-09 01:56:33','2022-11-09 01:56:33','2024-04-02 15:39:40','065535cc-a195-4a59-9584-acd0afbfd8a4'),(2,'redactor','3.0.4','2.3.0','2022-11-09 01:57:07','2022-11-09 01:57:07','2023-11-08 12:02:22','392c4d0c-c60f-45bd-815b-d617d8da4253'),(3,'mailgun','3.1.0','1.0.0','2022-11-09 01:57:24','2022-11-09 01:57:24','2024-04-02 15:07:50','d5b95be2-9213-4223-becc-2ddbf89dddca'),(4,'ckeditor','4.0.3','3.0.0.0','2023-11-08 12:03:12','2023-11-08 12:03:12','2024-04-02 15:39:40','97eb5f53-78fc-4c7b-a18b-db332c1224f1'),(5,'oembed','3.0.8','1.0.1','2024-04-02 15:43:16','2024-04-02 15:43:16','2024-04-02 15:43:16','7aef7e64-7960-4a3c-898c-e3c9e0108364');
...
set autocommit=0;
INSERT INTO `users` VALUES (1,NULL,1,0,0,0,1,'admin','',NULL,NULL,'info@putyourlightson.com','$2y$13$xOsg1jPHua8xRFpmyoWsReP0clcOlLK/KRdDboj2i1gpvVjHJM6Vi','2024-04-02 15:39:59',NULL,NULL,NULL,'2023-11-09 18:11:42',NULL,1,NULL,NULL,NULL,0,'2023-11-09 18:11:57','2022-11-09 01:55:11','2024-04-02 15:39:59');
